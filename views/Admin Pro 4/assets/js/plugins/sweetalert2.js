    ...
    if (innerParams.toast) {
      ...
      domCache.popup.onmousedown = function () {
        domCache.container.onmouseup = function (e) {
          ...
          // Only check if the mouseup target is the container because usually it doesn't
      ...
      domCache.container.onmousedown = function () {
        domCache.popup.onmouseup = function (e) {
          ...
          // Also need to check if the mouseup target is a child of the popup
...
// `catch` cannot be the name of a module export, so defined our thenable methods here instead
