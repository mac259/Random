! function(a, b) {
    ...
    // done to register the method called with moment() without creating circular dependencies.
    function b(a) {
        md = a
    }
    ...
    function e(a) {
        var b;
        for (b in a)
            // even if its not own property it should still be called non-empty
            return !1;
        return !0
    }
    ...
    // no arguments are passed in, it will simply return the current global locale key.
    function Za(a, b) {
        var c;
    ...
    function hb(a) {
        ...
        if (!a._d) {
            ...
            24 === a._a[_d] && 0 === a._a[ae] && 0 === a._a[be] && 0 === a._a[ce] && (a._nextDay = !0, a._a[_d] = 0), a._d = (a._useUTC ? sa : ra).apply(null, f),
                // Apply timezone offset from input. The actual utc Offset can be changed
                // with parseZone.
    ...
    function vb(a) {
        ...
        this._milliseconds = +k + 1e3 * j + // 1000
            ...
            // day when working around DST, need to store them separately
            this._days = +g + 7 * f,
            // It is impossible to translate months into days without knowing
            // which months are being talked about, so have to store it separately.
    ...
    // +0200, so adjust the time as needed, to be valid.

    // Keeping the time actually adds/subtracts (one hour)
    // from the actual represented time. That is why call updateOffset
    ...
    function Nb(a, b) {
        // Normally use ~~inp for this, but unfortunately it also
    ...
    // This function allows to set the rounding function for relative time strings
    function id(a) {
        return void 0 === a ? jf : "function" == typeof a ? (jf = a, !0) : !1
    }
    // This function allows to set a threshold for relative time strings
    function jd(a, b) {
    ...
    function ld() {
        // for ISO strings do not use the normal bubbling rules:
    ...
    T("d", 0, "do", "day"), T("dd", 0, 0, function(a) {
        ...
        Y("d", Kd), Y("e", Kd), Y("E", Kd), Y("dd", function(a, b) {
            ...
            // if didn't get a weekday name, mark the date as invalid
